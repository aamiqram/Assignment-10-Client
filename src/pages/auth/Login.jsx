          ...
          <form className="space-y-6 relative z-10">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border border-base-300 dark:border-gray-600 bg-base-200 dark:bg-gray-700 text-base-content dark:text-white focus:border-primary focus:ring-1 focus:ring-primary transition-colors"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-base-content dark:text-white mb-2">
